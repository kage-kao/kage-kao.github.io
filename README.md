<div align="center" onclick="document.getElementsByTagName('video')[0].muted=false;" style="padding: 50px 0; position: relative; z-index: 10; font-family: 'Courier New', Courier, monospace; color: #e0e0e0; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; -webkit-tap-highlight-color: transparent; -webkit-touch-callout: none;">
...
<summary onclick="document.getElementsByTagName('video')[0].muted=false;" style="cursor: pointer; outline: none; letter-spacing: 2px; text-shadow: 0 0 10px rgba(255,255,255,0.3);">END_SESSION.</summary>
